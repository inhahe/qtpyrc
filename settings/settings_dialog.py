...
# The tree's shape and the path generator live in settings.page_registry, so
# that naming the pages does not import them -- see that module's docstring.
# Re-exported here because this is where callers have always looked for them.
from settings.page_registry import (SETTINGS_PAGES, NETWORK_SUB_PAGES,
                                    get_settings_ui_paths)
